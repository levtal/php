...
include "valid_user.php"; // Check that this manager SESSION value is in fact in the database
...
<div align="left" style="margin-left:24px;">
  ...
  <form action="inventory_edit.php" enctype="multipart/form-data" 
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="6">
      ...
      <tr>
        ...
        <td><label>
          <textarea name="details" id="details" cols="64" rows="5">
		    <?php echo $details; ?>
		  </textarea>
        </label></td>
      </tr>
